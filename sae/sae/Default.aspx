...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sae_dbConnectionString %>" SelectCommand="SELECT [cod_usu], [des_usu], [login_usu], [pass_usu], [ce_usu], [foto_usu], [cod_perfil], [cod_school] FROM [sae1100] ORDER BY [cod_usu]"></asp:SqlDataSource>
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Usuarios - Detalle</h3>
                ...
                <div class="box-body">
    <asp:FormView ID="FormView1" class="table table-bordered table-striped" runat="server" DataKeyNames="cod_usu" DataSourceID="SqlDataSource2">
        <EditItemTemplate>
            <br />
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:sae_dbConnectionString %>" DeleteCommand="DELETE FROM [sae1100] WHERE [cod_usu] = @cod_usu" InsertCommand="INSERT INTO [sae1100] ([cod_usu], [des_usu], [login_usu], [pass_usu], [ce_usu], [foto_usu], [cod_perfil], [cod_school]) VALUES (@cod_usu, @des_usu, @login_usu, @pass_usu, @ce_usu, @foto_usu, @cod_perfil, @cod_school)" SelectCommand="SELECT [cod_usu], [des_usu], [login_usu], [pass_usu], [ce_usu], [foto_usu], [cod_perfil], [cod_school] FROM [sae1100] WHERE ([cod_usu] = @cod_usu) ORDER BY [cod_usu]" UpdateCommand="UPDATE [sae1100] SET [des_usu] = @des_usu, [login_usu] = @login_usu, [pass_usu] = @pass_usu, [ce_usu] = @ce_usu, [foto_usu] = @foto_usu, [cod_perfil] = @cod_perfil, [cod_school] = @cod_school WHERE [cod_usu] = @cod_usu">
        <DeleteParameters>
